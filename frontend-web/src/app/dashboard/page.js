      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col justify-between">
            ...
            <Link href="/dashboard/tools/writing-feedback" className="text-xs font-semibold text-emerald-700 mt-4 inline-block no-underline hover:underline">
              Buka Fitur →
            </Link>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col justify-between">
            ...
            <Link href="/dashboard/tools/worksheet-generator" className="text-xs font-semibold text-emerald-700 mt-4 inline-block no-underline hover:underline">
              Buka Fitur →
            </Link>
          </div>
