...
export default function SettingsPage() {
  ...
  const [user, setUser] = useState({ 
    nama_lengkap: "K.H. Abdullah Rahman, M.Pd.",
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <div>
        ...
        <p className="text-[13px] text-gray-500 m-0 mt-2">Kelola profil, madrasah, notifikasi, dan keamanan akun Anda.</p>
      </div>
        ...
        <div className="bg-white rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 p-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="flex items-center gap-4 mb-10">
            ...
            <div>
              ...
              <p className="text-[13px] text-gray-500 m-0 mt-0.5">{user.role === 'kepala_sekolah' ? 'Kepala Madrasah' : 'Guru'}</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSave} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-[13px] text-gray-700 mb-2 font-semibold">Jabatan</label>
                <input 
                  type="text" 
                  defaultValue={user.role === 'kepala_sekolah' ? 'Kepala Madrasah' : 'Guru'}
                  readOnly
