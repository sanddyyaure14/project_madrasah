...
export default function DashboardLayout({ children }) {
  return (
    <div className="flex h-screen bg-[#FAF9F5] text-gray-800 antialiased m-0 font-sans w-full">
      {/* SIDEBAR NAVIGASI */}
      <aside className="w-64 bg-[#006747] text-white flex flex-col justify-between shadow-lg shrink-0">
        <div>
          ...
          <nav className="px-2 py-4 space-y-1">
            ...
            <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-emerald-100 hover:bg-white/5 no-underline">
              <span className="text-base">⊞</span> Dashboard
            </Link>
            <Link href="/dashboard/tools/writing-feedback" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-emerald-100 hover:bg-white/5 no-underline">
              <span className="text-base">✍</span> Writing Feedback
            </Link>
            <Link href="/dashboard/tools/worksheet-generator" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-emerald-100 hover:bg-white/5 no-underline">
