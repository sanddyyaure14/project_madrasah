...
export default function GuruLayout({ children }) {
  ...
  return (
    <div className="flex h-screen bg-[#FDFBF7] text-gray-800 antialiased font-sans w-full overflow-hidden">
      {/* ── SIDEBAR ── */}
      <aside className="w-64 bg-[#0A261D] text-white flex flex-col justify-between shadow-xl shrink-0 overflow-y-auto hidden-scrollbar">
        <div>
          ...
          <div className="p-6 pb-4">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 bg-[#ECA823] rounded-lg flex items-center justify-center text-black font-bold text-xl font-serif">
                م
              </div>
              <div>
                <h1 className="font-bold text-[15px] tracking-wide m-0 text-white">MadrasahAI</h1>
                <p className="text-[9px] text-[#ECA823] tracking-widest font-semibold m-0 mt-0.5">
                  GURU CERDAS · BERKAH
                </p>
              </div>
            </div>
            <div className="inline-flex items-center gap-2 bg-[#006747] border border-emerald-700/50 text-white text-[10px] font-bold px-3 py-1.5 rounded-full mt-2">
          ...
          <div className="px-3 pb-6 space-y-6">
            ...
            {/* Asesmen */}
            <div>
              <p className="px-3 text-[10px] uppercase font-bold tracking-widest text-emerald-400/50 mb-2">
                Asesmen
              </p>
        ...
        <div className="p-5 border-t border-white/10 mt-auto">
          <div className="mb-4">
            ...
            <p className="text-[11px] text-emerald-300/70 m-0 mt-0.5 truncate">
              Guru {user.mata_pelajaran || "Mata Pelajaran"}
            </p>
          </div>
          <div className="space-y-2">
            <Link
              href="/dashboard/guru/settings"
              className="flex items-center gap-3 text-[13px] text-emerald-100/70 hover:text-white w-full transition-colors no-underline"
            >
            ...
            <button
              ...
              className="flex items-center gap-3 text-[13px] text-red-400 hover:text-red-300 w-full text-left transition-colors cursor-pointer"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Topbar */}
        <header className="h-16 bg-[#FDFBF7] flex items-center justify-between px-8 shrink-0 border-b border-gray-100/50 z-10">
          <div className="flex items-center gap-2">
            <span className="text-xl text-[#ECA823]" dir="rtl" style={{ fontFamily: "Amiri, serif" }}>
              السلام عليكم
            </span>
          ...
          <div className="flex items-center gap-4">
            <button className="px-4 py-1.5 border border-gray-200 rounded-full text-[12px] font-semibold text-gray-700 hover:bg-gray-50 transition-colors shadow-sm bg-white">
              Upgrade ke Pro
            </button>
            <Link
              href="/dashboard/guru/settings"
              className="w-9 h-9 rounded-full bg-[#006747] text-white font-bold flex items-center justify-center text-[13px] shadow-sm no-underline"
            >
