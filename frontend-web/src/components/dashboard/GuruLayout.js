      ...
      <aside className="w-64 bg-[#0A261D] text-white flex flex-col justify-between shadow-xl shrink-0 overflow-y-auto hidden-scrollbar">
        <div>
          ...
          <div className="px-3 pb-6 space-y-6">
            {/* Dashboard Root */}
            <div>
              <Link href="/dashboard/guru" className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-[13px] font-medium transition-colors ${pathname === '/dashboard/guru' ? 'bg-[#153428] text-[#ECA823] shadow-inner border border-white/5' : 'text-emerald-100/70 hover:bg-white/5 hover:text-white'}`}>
        ...
        <div className="p-5 border-t border-white/10 mt-auto">
          <div className="mb-4">
            ...
            <p className="text-[11px] text-emerald-300/70 m-0 mt-0.5 truncate">Guru {user.mata_pelajaran || 'Mata Pelajaran'}</p>
          </div>
          <div className="space-y-2">
            <Link href="/dashboard/guru/settings" className="flex items-center gap-3 text-[13px] text-emerald-100/70 hover:text-white w-full text-left transition-colors no-underline">
            ...
            <button onClick={handleLogout} className="flex items-center gap-3 text-[13px] text-red-400 hover:text-red-300 w-full text-left transition-colors cursor-pointer">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <header className="h-16 bg-[#FDFBF7] flex items-center justify-between px-8 shrink-0 z-10 border-b border-gray-100/50">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/dashboard/guru/settings" className="w-9 h-9 rounded-full bg-[#006747] text-white font-bold flex items-center justify-center text-[13px] shadow-sm cursor-pointer no-underline">
